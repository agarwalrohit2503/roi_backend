...
async function getProfile(req, res) {
  ...
  //   LEFT JOIN ${
  //     tableNames.brand_type
  //   } as bnd_type ON b.brand_type_id  = bnd_type.brand_type_id
  //   LEFT JOIN  ${
  //     tableNames.brand_industry
  //   } as bndindt ON b.brands_id  = bndindt.brand_id
  //    LEFT JOIN  ${
  //      tableNames.industry
  //    } as  industry ON bndindt.industry_id  =  industry.industry_id
  //    LEFT JOIN ${
  //      tableNames.brands_file
  //    }  as brands_file ON b.brands_id  = brands_file.brand_id
